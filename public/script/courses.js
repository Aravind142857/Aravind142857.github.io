        ...
        return (
            <div className="page-container py-8">
                <ul>
                    ...
                    <li><BlogCard course="CS 47a" image={"./images/scheme.png"} semester={"Fall 2022"} courseName={"Completion of work in CS 61A"} description={"Generic operations, streams and operators, scheme programming language."} /></li>
                    <li><BlogCard course="PHIL 12A" image={"./images/logic.jpg"} semester={"Fall 2022"} courseName={"Introduction to Logic"} description={"Syntax, semantics, proof theory of sentential and predicate logic."} /></li>
                    <li><BlogCard course="MATH 104" image={"./images/Real-Analysis.png"} semester={"Spring 2023"} courseName={"Introduction to Analysis"} description={"The Real Number System, Sequences, Limits, and continuous functions in R and R, Metric Space, Uniform convergence, interchange of limits, infinite series, mean value theorem, Reimann Integral."} /></li>
                    <li><BlogCard course="MATH 115" image={"./images/number-theory.png"} semester={"Spring 2023"} courseName={"Introduction to Number Theory"} description={"Divisibility, congruences, numerical functions, theory of primes, Diophantine analysis, continued fractions, partitions, quadratic fields."} /></li>
                    <li><BlogCard course="CS 61C" image={"./images/61c.jpg"} semester={"Spring 2023"} courseName={"Great Ideas of Computer Architecture (Machine Structures)"} description={"Internal organization and Operation of computers, Machine Architecture, Support for High Level Languages and Operating Systems, C Programming Languages, RISC-V assembly language, Computer Logic design."} /></li>
                    <li><BlogCard course="CS 188" image={"./images/ai.jpeg"} semester={"Spring 2023"} courseName={"Introduction to Artificial Intelligence"} description={"Search, Game playing, Knowledge Representation, Inference, Planning, Reasoning under uncertainty, Machine Learning, Introduction to Neural Networks."} /></li>
                    <li><BlogCard course="HISTORY 137AC" image={"./images/immigration.jpg"} semester={"Spring 2023"} courseName={"Immigrants and Immigration as U.S. History"} description={"U.S. immigration from colonial period to present - causes and patterns of migration, politics of race, ethnicity, class, religion, and gender over immigration, meaning of citizenship, xenophobia."} /></li>
                    <li><BlogCard course="Art 23AC" image={"./images/art23ac.png"} semester={"Fall 2023"} courseName={"Digital Media: Foundations"} description={"Data generation, visualization, and their impact on real persons, environments, and situations, role of privacy, role of sampling, animation, video, interactive design and music in shaping American Culture."} /></li>
                    <li><BlogCard course="MATH 136" image={"./images/incompleteness.jpg"} semester={"Fall 2023"} courseName={"Incompleteness and Undecidability"} description={"Functions computable by Algorithm, Turing Machines, Church's Thesis, Halting Problem, Rice's Theorem, Recursively enumerable sets, self-referential programs, Godel's incompleteness theorem."} /></li>
                    <li><BlogCard course="MATH 143" image={"./images/math-143.jpg"} semester={"Fall 2023"} courseName={"Elementary Algebraic Geometry"} description={"Introduction to basic commutative algebra, algebraic geometry, computational techniques, curves, surfaces, Grassmannian varieties"} /></li>
                    <li><BlogCard course="CS 161" image={"./images/cs161.jpg"} semester={"Fall 2023"} courseName={"Computer Security"} description={"Introduction to Computer Security, Cryptography (Encryption, Authentication, Hash Function, Cryptographic protocols), OS security, Network security, firewalls, viruses, worms, software security, defensive programming."} /></li>
                    <li><BlogCard course="CS 189" image={"./images/cs-189.jpg"} semester={"Fall 2023"} courseName={"Introduction to Machine Learning"} description={"Supervised methods for regression and classification (linear models, trees, neural networks, ensemble method, instance based methods), generative and discriminative probabilistic models, Bayesian parametric learning"} /></li>
                </ul>
            </div>
        )
    }
