        ...
        return (
            <div className="page-container py-8">
                <ul>
                    ...
                    <li><BlogCard course="CHEM 1A" image={"./images/cs88.jpeg"} semester={"Fall 2021"} courseName={"General Chemistry"} description={"Stoichiometry of chemical reactions, quantum mechanical description of atoms, thermochemistry, chemical kinetics."} /></li>
                    <li><BlogCard course="MATH 54" image={"./images/cs88.jpeg"} semester={"Spring 2022"} courseName={"Linear Algebra and Differential Equations"} description={"Linear Algebra, vector spaces, eigenvectors, eigenvalues, orthogonality, second order differential equation, Fourier series"} /></li>
                    ...
                    <li><BlogCard course="PLANTBI 40" image={"./images/PlantBio40.gif"} semester={"Spring 2022"} courseName={"The (Secret) Life of Plants"} description={"How plants grow, reproduce and respond to the environment, basics of genetic engineering and biotechnology, plant disease and diversity."} /></li>
                    <li><BlogCard course="HISTORY 190" image={"./images/History190.jpeg"} semester={"Spring 2022"} courseName={"Soccer: A Global History"} description={"How and why soccer came to happen, changes in stadiums, fan culture, media coverage and formations in the context of political and socio-cultural changes in society."} /></li>
                    <li><BlogCard course="MATH 110" image={"./images/cs88.jpeg"} semester={"Fall 2022"} courseName={"Linear Algebra"} description={"Matrices, vector spaces, inner products, determinants, eigenvectors, QR factorization, Linear Functionals, Jordan canonical forms."} /></li>
                    <li><BlogCard course="MATH 113" image={"./images/cs88.jpeg"} semester={"Fall 2022"} courseName={"Introduction to Abstract Algebra"} description={"Sets and relations, integers, congruences, groups, factor groups, commutative rings, ideals and quotient fields."} /></li>
                    <li><BlogCard course="CS 61B" image={"./images/CS61B.gif"} semester={"Fall 2022"} courseName={"Data structures"} description={"Fundamental dynamic data structures: linear lists, queues, trees, array strings, hashtable, storage management, principles of software engineering, sorting and searching, Java."} /></li>
                    <li><BlogCard course="CS 47a" image={"./images/cs88.jpeg"} semester={"Fall 2022"} courseName={"Completion of work in CS 61A"} description={"Generic operations, streams and operators, scheme programming language."} /></li>
