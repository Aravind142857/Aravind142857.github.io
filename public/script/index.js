        ...
        <footer className="footer p-10 bg-transparent text-neutral-content text-black font-bodoni_moda">
            ...
            <div>
                ...
                <div className="grid grid-flow-col gap-4">
                    <!-- Instagram logo -->
                    <a href="https://www.instagram.com/aravind_02_10">
                        <svg className="scale-100" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <!-- GitHub logo -->
                    <a href="https://github.com/Aravind142857">
                        <svg className="fill-black" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                             viewBox="0 0 24 24">
                            <path
                    ...
                    <!-- LinkedIn Logo -->
                    <a href="https://www.linkedin.com/in/aravindsrinivasan02">
                        <svg className="fill-[#0077b5]" height="24" width="24"  xmlns="http://www.w3.org/2000/svg"
...
<g>
    ...
    <path style="fill-rule:evenodd;clip-rule:evenodd;" d="M0,0v455h455V0H0z M141.522,378.002H74.016V174.906h67.506V378.002z
		...
		z"/>
                ...
                <a className="grid grid-flow-col gap-4 text-black opacity-50" href="mailto:aravind.s2002@gmail.com">
                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-current"
                         xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 256 256"
                         xml:space="preserve">
